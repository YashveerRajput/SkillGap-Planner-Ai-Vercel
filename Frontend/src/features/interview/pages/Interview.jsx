        ...
        <div className='interview-page'>
            ...
            {toast && (
                <div className='resume-toast'>
                    <span className='resume-toast__icon'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><polyline points="12 6 12 12 16 14"/></svg>
                    </span>
                    <div>
                        <p className='resume-toast__title'>Resume generation in progress</p>
                        <p className='resume-toast__sub'>Your resume will download shortly…</p>
                    </div>
                </div>
            )}
