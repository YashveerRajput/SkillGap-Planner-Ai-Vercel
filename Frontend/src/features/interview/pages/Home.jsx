...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        if (!jobDescription.trim()) {
            setValidationError("Please paste the job description before generating.")
            return
        }
        if (!resumeFile && !selfDescription.trim()) {
            setValidationError("Please upload a resume or write a self description.")
            return
        }
        setValidationError("")
        try {
        ...
        <div className='home-page'>
            ...
            <div className='interview-card'>
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='info-box'>
                            ...
                            <p><strong>Resume</strong> and <strong>Self Description</strong> both are required to generate a personalized plan.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='interview-card__footer'>
                    {validationError && (
                        <span className='footer-error'>{validationError}</span>
                    )}
